    ...
    dict(slug="ypiresies/theta-healing.html",
         ...
         photos=[dict(f="svc-theta-healing",
                      el=("Δύο ζευγάρια χέρια ακουμπισμένα σε ξύλινο τραπέζι, με αναμμένο κερί και κρυστάλλους στο βάθος",
                          "Theta Healing: καθοδηγούμενος διαλογισμός σε κατάσταση θήτα εγκεφαλικών κυμάτων."),
                      en=("Two pairs of hands resting on a wooden table, with a lit candle and crystals in the background",
                          "Theta Healing: guided meditation in a state of theta brain waves."))],
         el=dict(nav="Theta Healing", who="Κάθε ηλικία", short="Theta Healing",
                 teaser="Καθοδηγούμενος διαλογισμός σε κατάσταση θήτα εγκεφαλικών κυμάτων, εκεί όπου δουλεύονται πολύ βαθιά κομμάτια. Χωρίς ηλικιακό όριο."),
...
CATEGORIES = [
    ...
    dict(slug="ypiresies/energeiakes-therapeies.html",
         ...
         photos=[dict(f="svc-theta-healing",
                      el=("Δύο ζευγάρια χέρια ακουμπισμένα σε ξύλινο τραπέζι, με αναμμένο κερί και κρυστάλλους στο βάθος",
                          "Theta Healing: διαλογισμός σε κατάσταση θήτα εγκεφαλικών κυμάτων, με δικές της συνεδρίες."),
                      en=("Two pairs of hands resting on a wooden table, with a lit candle and crystals in the background",
                          "Theta Healing: meditation in a state of theta brain waves, in its own sessions."))],
