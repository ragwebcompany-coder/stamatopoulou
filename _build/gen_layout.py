...
/* ---- πιστοποιητικό ----
   Κάθετο έγγραφο μέσα σε στήλη κειμένου: χωρίς όριο πλάτους θα κυριαρχούσε
   ολόκληρη τη σελίδα. Το πλαίσιο το κρατά «έγγραφο» και όχι φωτογραφία. */
.cb-figure--cert { max-width: 21rem; margin: 1.75rem 0 2.5rem; }
