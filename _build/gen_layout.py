...
.cb-hero__h1 { font-family: var(--font-serif); font-weight: 300; letter-spacing: -.02em;
  font-size: clamp(1.9rem, 4.6vw, 3.3rem); line-height: 1.16; margin: 1.1rem 0 1.75rem;
  text-shadow: 0 2px 24px rgba(18,16,76,.6), 0 1px 4px rgba(18,16,76,.35); }
.cb-hero__lede { max-width: 46rem; font-weight: 300; font-size: 1.08rem; line-height: 1.8;
  color: rgba(248,247,252,.88); text-shadow: 0 1px 12px rgba(18,16,76,.65); }
.cb-hero__actions { display: flex; flex-wrap: wrap; gap: .9rem; margin-top: 2.5rem; }
.cb-hero .cb-eyebrow--light { text-shadow: 0 1px 10px rgba(18,16,76,.7); }
...
/* Δύο βαθμίδες: μία καθ' ύψος, ώστε τα κουμπιά στο κάτω μέρος να πατούν σε
   σκούρο, και μία πλάγια, ώστε ο τίτλος αριστερά να μην κάθεται πάνω στα
   διπλώματα του τοίχου. */
.cb-hero__scrim { position: absolute; inset: 0;
  background: linear-gradient(180deg, rgba(18,16,76,.34) 0%, rgba(18,16,76,.08) 34%, rgba(18,16,76,.80) 100%),
              linear-gradient(96deg, rgba(18,16,76,.72) 0%, rgba(18,16,76,.16) 58%, rgba(35,32,102,0) 100%); }
/* Το πλέγμα φτιάχτηκε για κενό φόντο· πάνω σε φωτογραφία γίνεται θόρυβος. */
.cb-hero__photo ~ .cb-hero-grid { opacity: .06; }
@media (max-width: 900px) {
  .cb-hero__photo { object-position: 54% 38%; opacity: .66; }
  ...
  .cb-hero__scrim { background: linear-gradient(180deg, rgba(18,16,76,.42) 0%, rgba(18,16,76,.30) 26%, rgba(18,16,76,.88) 100%); }
}
...
.cb-hero__h1 { font-size: clamp(1.75rem, 5.6vw, 3.3rem); }
